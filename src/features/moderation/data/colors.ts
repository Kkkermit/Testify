import { type OptionChoice } from "../../../core/command";

/** The colour palette offered by `/announce`, `/create embed` and friends. */
export const COLOR_CHOICES: OptionChoice[] = [
...
export function resolveColor(input: string | null, fallback = "#7289da"): `#${string}` {
