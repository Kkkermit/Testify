...
export default defineCommand({
	...
	aliases: ["calc", "math"],
	options: [
		{ name: "expression", description: "The expression to evaluate.", type: "string", required: true, greedy: true },
	],

	async execute(ctx) {
		const expression = ctx.options.getString("expression", true).trim();
