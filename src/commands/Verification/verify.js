const { SlashCommandBuilder, PermissionsBitField, EmbedBuilder, ChannelType, ActionRowBuilder, ButtonBuilder, ButtonStyle, PermissionFlagsBits, MessageFlags } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        switch (sub) {
            ...
            if (data) return await interaction.reply({ content: `You **already** have a verification system **set up**! Do \`/verify disable\` to undo.`, flags: MessageFlags.Ephemeral});
            else {
                ...
                interaction.reply({ content: `Your **verification system** has been enabled!`, flags: MessageFlags.Ephemeral});
