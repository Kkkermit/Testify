document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('pre').forEach(block => {
        ...
        copyButton.className = 'absolute right-3 top-3 bg-white/10 hover:bg-white/20 border-none rounded px-3 py-1 text-white cursor-pointer transition-all';
    ...
    backToTopButton.className = 'fixed bottom-5 right-5 bg-primary hover:bg-primary-light text-white border-none rounded-full w-12 h-12 flex items-center justify-center cursor-pointer shadow-md transition-all duration-300 opacity-0 z-50';
    ...
    themeToggle.className = 'fixed bottom-5 left-5 bg-primary hover:bg-primary-light text-white border-none rounded-full w-12 h-12 flex items-center justify-center cursor-pointer shadow-md transition-all duration-300 z-50';
